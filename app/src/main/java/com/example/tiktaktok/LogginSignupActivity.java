                ...
                query.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull @org.jetbrains.annotations.NotNull DataSnapshot snapshot) {
                        ...
                        if (isUserNameTaken == false) {
                            ...
                            int picArr[] = {R.drawable.cat, R.drawable.duck, R.drawable.hors};
                            Random rand = new Random();
                            newPlayer = new Player(txt_username.getText().toString(), txt_password.getText().toString(), picArr[rand.nextInt(picArr.length)]); //here I need to change picture
